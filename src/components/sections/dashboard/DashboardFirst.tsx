      ...
      <div className="row">
        <div className="col-8 metatron">
          <div className="metatron-content">
            <h2>Bonjour Junnot</h2>
            <div className="content">
              <p>Vous ne savez pas ce que vous cherchez?</p>
              <p>
                Discuter avec <span>Métatron </span>“L’Ange du Savoir” 
                pour vous tout savoir 
              </p>
             ...
             <div className="row">
              <div className="col cmd">
                <div className="cmd-title">
                  <p>Cupidon</p>
                  <p><img src="/aile.svg" alt="" /><span>79</span></p>
                </div>
                <div className="cmd-img">
                  <img src="/angel4.png" alt="" className="image" />
                </div>
              </div>
              <div className="col cmd">
                <div className="cmd-title">
                  <p>Gabriel</p>
                  <p><img src="/aile.svg" alt="" /><span>67</span></p>
                </div>
                <div className="cmd-img">
                  <img src="/angel3.png" alt="" className="image" />
                </div>
              </div>
             </div>
          </div>
